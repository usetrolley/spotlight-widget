(function () {
  ...
  function initSpotlight() {
    ...
    Spotlight.prototype._getActiveSpotlight = function () {
      var that = this;
      client.get(baseUrl + '/spotlights/widget?workspaceId=' + this.workspaceId, function (response) {
    ...
    Spotlight.prototype._track = function (eventType) {
      var url = baseUrl + '/analytics/spotlights/' + this.spotlightId + '/' + eventType + '?workspace=' + this.workspaceId;
  ...
  function addStyleTag() {
    var styles = {
      ...
      '.spotlt_container .spotlt_button .spotlt_play-icon-circle .spotlt_icon': {
        ...
        'top': '5px',
        'transition-duration': '.2s',
        'border-color': 'transparent transparent transparent ' + spotlight.primaryColor,
      },
      ...
      '.spotlt_container .spotlt_button:hover .spotlt_play-icon-circle .spotlt_icon': {
        'border-color': 'transparent transparent transparent ' + spotlight.secondaryColor,
      },
    };
  ...
  function buildWidget() {
    var widgetContainerExists = document.getElementsByClassName('spotlt_container').length > 0;
    ...
    if (spotlight.headline) {
      ...
      if (spotlight.type === 'audio') {
        ...
        console.log('This spotlight type is not yet supported:', spotlight.type);
      }

      document.getElementsByClassName('spotlt_container')[0].appendChild(innerContainer);
  ...
  function createEventListeners() {
    ...
    function widthChange(mq) {
      ...
      var button = document.getElementsByClassName('spotlt_button')[0];
      var playIcon = document.getElementsByClassName('spotlt_play-icon-circle')[0];
